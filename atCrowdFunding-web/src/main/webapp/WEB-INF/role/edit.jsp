        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="editRoleForm" action="/user" method="post" role="form">
                        <div class="form-group">
                            <label for="rolename">角色名称</label>
                            <input type="text" class="form-control" id="rolename" name="rolename" value="${role.rolename}" placeholder="请输出角色名">
                        </div>
    ...
    $(function () {
        ...
        $("#updateBtn").click(function () {
            ...
            $.ajax({
                ...
                //实现等待时间的加载
                beforeSend:function () {
                    loadingIndex = layer.msg('更新角色信息中',{icon:16});
                },
                success:function (result) {
                    layer.close(loadingIndex);
                    if(result.success){
                        //说明添加成功
                        layer.msg("修改角色信息成功",{time:1000,icon:6,shift:3},function () {
                            window.location.href="roles";
                        });
                    }else{
                        layer.msg("角色信息修改失败，请重新操作",{time:1500,icon:5,shift:6},function () {});
                    }
                }
            });
        });
